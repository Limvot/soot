 ...
 */
public abstract class DefaultUpdatableJimpleIFDSTabulationProblem<D,I extends UpdatableInterproceduralCFG<Unit,SootMethod>>
		extends DefaultIFDSTabulationProblem<UpdatableWrapper<Unit>,D,UpdatableWrapper<SootMethod>,I> {

	public DefaultUpdatableJimpleIFDSTabulationProblem(I icfg) {
		super(icfg);
	}
